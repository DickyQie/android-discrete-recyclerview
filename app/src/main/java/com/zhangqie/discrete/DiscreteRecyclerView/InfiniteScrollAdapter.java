...
public class InfiniteScrollAdapter<T extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<T>
        implements DiscreteRecyclerLayoutManager.InitialPositionProvider {
    ...
    public void onAttachedToRecyclerView(@NonNull RecyclerView recyclerView) {
        ...
        if (recyclerView instanceof DiscreteRecyclerView) {
            layoutManager = (DiscreteRecyclerLayoutManager) recyclerView.getLayoutManager();
        } else {
