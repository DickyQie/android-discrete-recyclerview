package com.zhangqie.discrete.DiscreteRecyclerView;
...
import com.zhangqie.discrete.DiscreteRecyclerView.transform.DiscreteScrollItemTransformer;

import java.util.Locale;

class DiscreteRecyclerLayoutManager extends RecyclerView.LayoutManager {
    ...
    public DiscreteRecyclerLayoutManager(
            @NonNull Context c,
